...
This page walks through getting Hover into a project you already have. For the absolute fastest path, the [Quick start](/docs/get-started/quick-start) is the shorter version of the same steps; come back here if anything goes sideways.
