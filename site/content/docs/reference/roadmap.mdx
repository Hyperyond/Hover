...
- **A living test wiki.** A richer `.hover/` memory layer — a relationship graph linking flows, pages, and the endpoints they touch, plus coverage-gap detection — over the business map + remembered rules that ship today. No source uploaded.
