...
Hover is a free, open-source MCP server. You add it to the coding agent you already run — `claude mcp add hover -- npx -y @hover-dev/mcp` — and that is the whole transaction. There is no account, no seat, no monthly charge from us.
