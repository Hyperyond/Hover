...
That single yes-or-no decides what your test suite costs you for the rest of its life. Here is why.
...
Fair, and you should ask it of any AI-authored test. Hover answers in three ways, and none of them is "call a model on every run."
