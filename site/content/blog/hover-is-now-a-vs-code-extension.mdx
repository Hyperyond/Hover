...
2. Make sure one coding-agent CLI is on your `PATH` — [Claude Code](https://claude.com/claude-code) or [OpenAI Codex](https://github.com/openai/codex) — signed in with the subscription you already pay for. That's the only thing to configure; Hover bundles no model SDK and no keys of its own.
