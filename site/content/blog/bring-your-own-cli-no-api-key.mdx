...
Hover skips the field. Hover ships no model client, so there's nothing inside it to hold a key. It runs the coding-agent CLI you already installed.
...
You stay free to switch models. The model is a binary on your PATH, so changing providers means changing binaries. The day a model gets cheaper or faster or better at browser work, you point Hover at it. No migration, no re-platforming.
