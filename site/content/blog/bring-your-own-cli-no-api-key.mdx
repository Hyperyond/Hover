...
You wire Hover into the agent you already use — one command, e.g. `claude mcp add hover -- npx -y @hover-dev/mcp`. From then on, Hover is just a set of tools that agent can call:
