...
export const DOCS_NAV: DocSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'API testing', href: '/docs/features/api-testing/' },
      { text: 'Self-heal', href: '/docs/features/self-heal/' },
      { text: 'Page Objects', href: '/docs/features/page-objects/' },
      { text: 'Login & credentials', href: '/docs/features/auth/' },
